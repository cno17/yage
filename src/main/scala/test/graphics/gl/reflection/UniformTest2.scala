...
// todo: load program from classpath: getResourceAsStream()

object UniformTest2 extends App:

  override def init() =
    val p = Program(File(File("src/main/scala/test/graphics/gl/reflection"), "UniformTest2.vert"))
